...
(function () {
    ...
    ui.Pages.define(searchPageURI, {
        ...
        ready: function (element, options) {
            ...
            listView.itemTemplate = document.getElementById('waitlistEntryTemplate');
        ...
        _generateFilters: function () {
            ...
            this._filters.push({ results: null, text: "Waiting", predicate: function (item) { return item.state === 'Waiting'; } });
            this._filters.push({ results: null, text: "Sent", predicate: function (item) { return item.state === 'Sent'; } });
        },
        ...
        _searchData: function (queryText) {
            return Guam.Data.list.createFiltered(function (item) {
                return item.name.indexOf(queryText) >= 0;
            });
        }
    });
